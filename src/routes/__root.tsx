...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;600;700;800&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@500;600;700&family=Sora:wght@700;800&display=swap",
      },
    ],
  }),
...
function RootComponent() {
  ...
  useEffect(() => {
    // Init analytics tracker only on the public site (not /admin/*).
    if (typeof window === "undefined") return;
    if (window.location.pathname.startsWith("/admin")) return;
    void import("../lib/tracker").then((m) => m.initTracker());
  }, []);
